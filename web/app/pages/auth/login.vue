  ...
  <div class="min-h-screen flex bg-white">
    ...
    <div class="flex-1 flex items-center justify-center px-6 py-12 lg:px-20">
      <div class="w-full max-w-sm">
        ...
        <form @submit.prevent="handleLogin" class="space-y-5">
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input id="login-email" v-model="form.email" type="email" required placeholder="you@example.com"
          ...
          <div>
            <div class="flex items-center justify-between mb-1.5">
              ...
              <NuxtLink to="/auth/forgot"
                ...
                id="login-forgot-link">Forgot password?</NuxtLink>
            </div>
            <div class="relative">
              <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#a3a3a3" stroke-width="2">
        ...
        <!-- Social Login -->
        <button id="login-google" @click="handleGoogleLogin" :disabled="isLoading"
        ...
        <p class="mt-8 text-center text-sm text-surface-500">
          ...
          <NuxtLink to="/auth/welcome" class="font-medium text-brand-600 hover:text-brand-700 transition-colors"
            id="login-signup-link">Sign up</NuxtLink>
        </p>
      </div>
    </div>
    ...
    <div class="hidden lg:flex flex-1 items-center justify-center bg-surface-50 relative overflow-hidden">
      ...
      <div class="relative text-center max-w-sm px-8">
        ...
        <p class="text-sm text-surface-500 leading-relaxed">Highlight any word on any webpage to instantly learn its
          meaning, pronunciation, and usage.</p>
      </div>
    </div>
  </div>
</template>
